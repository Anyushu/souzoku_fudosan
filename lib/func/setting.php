...
function arphabet_widgets_init()
{
    register_sidebar([
        'name' => 'サイドバー',
        'id' => 'sidebar',
        'before_widget' => '<div class="archive__wrap__side__inner">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="archive__wrap__side__inner__ttl">',
        'after_title' => '</h3>',
    ]);
}
...
function login_logo()
{
    $logo = get_template_directory_uri().'/lib/images/logo_admin.png';
    echo '<style type="text/css">.login h1 a{background-image: url('.$logo.');background-size: 300px;height: auto;width: 300px;}</style>';
}
